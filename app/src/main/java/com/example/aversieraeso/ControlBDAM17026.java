...
public class ControlBDAM17026 {
    ...
    public ControlBDAM17026(Context ctx) {
        this.context = ctx;
...
// TODO Auto-generated method stub
    ...
    public String actualizar(Alumno alumno){
        ...
        if(verificarIntegridad(alumno, 5)){
            ...
            return "Registro con carnet " + alumno.getCarnet() + " no " +
                    "existe";
        }
    }
    ...
    public String eliminarMateria(Materia materia){return null;}
    public String actualizar(Nota nota){
        ...
        if(verificarIntegridad(nota, 2)){
            ...
            db.update("nota", cv, "codmateria = ? AND carnet = ? AND " +
                    "ciclo = ?", id);
            return "Registro Actualizado Correctamente";
        }else{
